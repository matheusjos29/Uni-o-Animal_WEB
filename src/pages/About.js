function About(){
    return(
        <div>
            <h1>About</h1>
            <h3>SOBRE</h3>
            <p style={{ fontSize: '16px', fontFamily: 'Helvetica', textAlign: 'justify' }}>
            ...
            <h3>EQUIPE</h3>
            <p style={{ fontSize: '16px', fontFamily: 'Helvetica', textAlign: 'justify' }}>
            <br />José Gabriel Gadiolli Lourenço da Paixão  | 01603195
            <br />Matheus José dos Santos Silva             | 01597670
            <br />Rebecca Costa Florêncio Wanderley         | 0159073
            </p>

            <h3><a href="https://github.com/MatheusArtur0/PetHelp-WEB.git" target="_blank" rel="noopener noreferrer">(Link GitHub)</a></h3>
        </div>
